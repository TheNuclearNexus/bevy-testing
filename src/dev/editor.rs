...
use bevy_inspector_egui::{
    ...
    bevy_egui::{EguiGlobalSettings, EguiPrimaryContextPass, PrimaryEguiContext},
};
use egui_dock::{
    DockArea, DockState, NodeIndex, Style,
    egui::{self, LayerId},
};
use std::any::TypeId;
...
impl Plugin for EditorPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(super::picking::RapierPickingPlugin)
